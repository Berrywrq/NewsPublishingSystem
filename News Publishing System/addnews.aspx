<%@ Page Title="添加新闻_后台管理" Language="C#" MasterPageFile="~/m_common.master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="addnews.aspx.cs" Inherits="News_Publishing_System.addnews" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="m_contentPlaceHolder" runat="server">
     <div id="addnews" class="round2">
        ...
        <div class="con">
            ...
            </p>        --%>&nbsp;<p><asp:Button ID="btnAdd" runat="server" Text="添加新闻" BackColor="#ABCDF3" BorderStyle="Double" BorderWidth="1px" OnClick="btnAdd_Click" /></p>      
        </div>
        <div class="footer">
            <p>&nbsp;</p>
        </div>
